        ...
        <div className="flex flex-col gap-10 sm:flex-row sm:justify-between">
          ...
          <div className="grid grid-cols-2 gap-x-12 gap-y-8 sm:grid-cols-3">
            <FooterCol title="Product">
              ...
              {/* Printable SeedQR transcription templates. Generated by
                  raspberry-pi/src/bin/gen_templates.rs in the main repo;
                  regenerate there and re-copy if the design changes. */}
              <FooterLink href="/templates/seedqr-12-words.pdf" external>
                Backup template · 12w
              </FooterLink>
              <FooterLink href="/templates/seedqr-24-words.pdf" external>
                Backup template · 24w
              </FooterLink>
            </FooterCol>
